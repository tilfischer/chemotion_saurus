...
| Cyclic Voltammetry (CV)  | v0.8.0+     | CV PalmSens                         | CV data from pssession, data: +, metadata: + <br /> PalmSens PSTrace; ref location: IPB Halle / Uni Leipzig, data: +, metadata: +  | CV: PalmSens PSTrace 5.3  | *.pssession | [Link](https://github.com/ComPlat/chemotion_saurus/blob/main/static/files/shared_ChemConverter_files/profiles/CVprofile_PalmSens_PSTrace_5_3_pssession.json)       |
| Cyclic Voltammetry (CV)  | v0.8.0+     | CV PalmSens                         | CV data from pssession, data: +, metadata: + <br /> PalmSens PSTrace; ref location: IPB Halle / Uni Leipzig,, data: +, metadata: +  | CV: PalmSens PSTrace 5.9  | *.pssession | [Link](https://github.com/ComPlat/chemotion_saurus/blob/main/static/files/shared_ChemConverter_files/profiles/CVprofile_PalmSens_PSTrace_5_9_pssession.json)       |
